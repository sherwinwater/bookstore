...
public final class email_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("          onSubmit=\"Return ValidateForm()\" name=\"form1\">\n");
      ...
      out.write("        {\n");
      out.write("            if (document.form1.firstname.value == \"\" )\n");
      out.write("            {\n");
      out.write("                alert(\"first name should be left blank\");\n");
      out.write("                document.form1.firstname.focus();\n");
      out.write("                return false;\n");
      out.write("            } else if (document.form1.email.value == \"\")\n");
      out.write("            {\n");
      out.write("                alert(\"email should be left blank\");\n");
